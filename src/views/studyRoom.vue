  ...
  <el-row :gutter="20">
    ...
    <el-col :span="4">
      ...
      <div style="margin-top: 40px;"></div>
        <el-statistic ref="statistic" format="DD HH:mm:ss" :value="deadline4" title="距离考研：" time-indices > </el-statistic>
      </el-card>
...
export default {
   ...
   methods:{
    ...
    initWebSocket() { // 建立连接
                ...
                var url ="ws://localhost:10010/interaction/websocket/"+this.studyRoomId+this.user.userName;
